  ...
  <div v-if="libro" class="container mt-3">
    ...
    <div class="row">
      <div class="col-md-4 mb-3">
        ...
        <div v-else aria-hidden="true" class="bg-secondary-subtle text-muted rounded shadow d-flex align-items-center justify-content-center p-4 text-center fw-bold text-uppercase" style="aspect-ratio: 2/3; font-size: 0.9rem;">
          {{ copertinaUrl }}
        </div>
      </div>
      ...
      <div class="col-md-8">
        ...
        <span class="text-dark badge custom-genre-badge mt-3 mb-3" :aria-label="'Generi associati al libro: ' + generi">{{ generi }}</span>
      ...
      <div v-for="suggerito in libriSuggeriti" :key="suggerito.key" class="col-6 col-md-3 mb-4">
        <router-link :to="{ name: 'Descrizione', query: { work: suggerito.key.split('/').pop() }}" class="text-decoration-none">
          <div class="card h-100 shadow-sm">
            ...
            <div v-else class="d-flex align-items-center justify-content-center text-center p-3 small" style="color: var(--blu-notte); aspect-ratio: 2/3;">
